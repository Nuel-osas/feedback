...
Everything we know is worth doing but isn't part of the hackathon scope — AI form-builder, speech-to-execute, sponsored payments, subscription tiers, zkLogin, anonymous submissions — lives in [`TODO.md`](./TODO.md) at the repo root. That file is structured for easy sorting (by theme, priority, dependency) and is the source of truth for post-submission planning.
